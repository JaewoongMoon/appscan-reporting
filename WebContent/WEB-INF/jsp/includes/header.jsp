			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>
							<a href="http://10.248.90.234:8080/AppScanResult/js/lib/android/android.html"
							target="_blank">
							<code> Sample:  http://10.248.90.234:8080/AppScanResult/js/lib/android/android.html</code>
							</a><br/>
